...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiForSibyl2Server.ServiceFunctionContextChain();
  });
  ...
  describe('ServiceFunctionContextChain', function() {
    it('should create an instance of ServiceFunctionContextChain', function() {
      // uncomment below and update the code to test ServiceFunctionContextChain
      //var instance = new OpenapiForSibyl2Server.ServiceFunctionContextChain();
      //expect(instance).to.be.a(OpenapiForSibyl2Server.ServiceFunctionContextChain);
    });
    ...
    it('should have the property callChains (base name: "callChains")', function() {
      // uncomment below and update the code to test the property callChains
      //var instance = new OpenapiForSibyl2Server.ServiceFunctionContextChain();
      //expect(instance).to.be();
    });
    ...
    it('should have the property reverseCallChains (base name: "reverseCallChains")', function() {
      // uncomment below and update the code to test the property reverseCallChains
      //var instance = new OpenapiForSibyl2Server.ServiceFunctionContextChain();
      //expect(instance).to.be();
    });
