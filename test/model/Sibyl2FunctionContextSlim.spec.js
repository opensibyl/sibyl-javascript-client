...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiForSibyl2Server.Sibyl2FunctionContextSlim();
  });
  ...
  describe('Sibyl2FunctionContextSlim', function() {
    it('should create an instance of Sibyl2FunctionContextSlim', function() {
      // uncomment below and update the code to test Sibyl2FunctionContextSlim
      //var instance = new OpenapiForSibyl2Server.Sibyl2FunctionContextSlim();
      //expect(instance).to.be.a(OpenapiForSibyl2Server.Sibyl2FunctionContextSlim);
    });
