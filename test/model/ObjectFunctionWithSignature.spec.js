...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiForSibyl2Server.ObjectFunctionWithSignature();
  });
  ...
  describe('ObjectFunctionWithSignature', function() {
    it('should create an instance of ObjectFunctionWithSignature', function() {
      // uncomment below and update the code to test ObjectFunctionWithSignature
      //var instance = new OpenapiForSibyl2Server.ObjectFunctionWithSignature();
      //expect(instance).to.be.a(OpenapiForSibyl2Server.ObjectFunctionWithSignature);
    });
