...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiForSibyl2Server.Sibyl2FunctionWithPath();
  });
  ...
  describe('Sibyl2FunctionWithPath', function() {
    it('should create an instance of Sibyl2FunctionWithPath', function() {
      // uncomment below and update the code to test Sibyl2FunctionWithPath
      //var instance = new OpenapiForSibyl2Server.Sibyl2FunctionWithPath();
      //expect(instance).to.be.a(OpenapiForSibyl2Server.Sibyl2FunctionWithPath);
    });
